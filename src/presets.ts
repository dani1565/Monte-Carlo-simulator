...
export const presets: Preset[] = [
  { name: 'S&P היסטורי', description: 'בסיס ארוך טווח לשוק האמריקאי, עם זנבות לחץ (4.2) לבדיקת פגיעות במינוף.', values: { annualDrift: 0.09, annualVolatility: 0.18, degreesOfFreedom: 4.2, years: 20 } },
