...
const parameterExplanations = [
  ...
  ['עובי הזנבות', 'פרמטר טכני של התפלגות Student-t ששולט בתדירות של ימים קיצוניים. פחות דרגות חופש פירושן יותר אירועים חריגים, ולכן סיכון גדול יותר לקרן ממונפת.'],
