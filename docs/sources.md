...
טווח התפלגות Student-t הוא ממינוס אינסוף עד אינסוף, כפי שמתועד במקור NIST לעיל. כאשר משתמשים בה ישירות לתשואה פשוטה היא עלולה לכן להגריל ערך נמוך מ־‎-100%, אף ששווי מדד אינו יכול להיות שלילי. בהתאם ל־ADR 0007, המודל ממפה כל ערך גולמי כזה ל־‎-100% לפני החלת המינוף היומי. זהו אילוץ מתמטי של תשואה פשוטה, לא כיול היסטורי חדש ולא סף מחיקה מלאכותי של התיק.

החסימה משמרת את מספר ההגרלות ואת רצף ה־seed, אך יוצרת מסה נקודתית ב־‎-100% ועלולה לשנות מעט את הממוצע והתנודתיות הממומשים בתרחישים קיצוניים. ערכי הכיול וה־presets אינם משתנים בעקבות החלטה זו.
